...
export const btnBoxShadow = `inset 0 1px 0 rgba(${white},.15), 0 1px 1px ${sassRgba(black, 0.075)}`;
...
export const navLinkHeight = `${stripUnit(navbarBrandFontSize) * lineHeightBase}rem`;

export const navbarBrandHeight = `${stripUnit(fontSizeBase) * lineHeightBase + stripUnit(navLinkPaddingY) * 2}rem`;

export const navbarBrandPaddingY = `${(stripUnit(navbarBrandHeight) - stripUnit(navLinkHeight)) / 2}rem`;
...
export const paginationActiveBg = primary;
export const paginationActiveBorderColor = primary;
...
export const badgePrimaryBg = primary;
export const badgeSuccessBg = success;
export const badgeInfoBg = info;
export const badgeWarningBg = warning;
export const badgeDangerBg = danger;
...
export const inputBorderColorFocus = lighten(0.25, primary);
export const inputBoxShadowFocus = `${inputBoxShadow}, ${sassRgba(inputBorderColorFocus, 0.6)}`;
export const inputColorFocus = inputColor;
export const inputColorPlaceholder = gray600;

export const inputHeight = `${stripUnit(fontSizeBase) * inputBtnLineHeight + stripUnit(inputBtnPaddingY) * 2}rem`;

export const inputHeightLg = `${stripUnit(fontSizeLg) * inputBtnLineHeightLg + stripUnit(inputBtnPaddingYlg) * 2}rem`;

export const inputHeightSm = `${stripUnit(fontSizeSm) * inputBtnLineHeightSm + stripUnit(inputBtnPaddingYsm) * 2}rem`;
...
export const progressBarBg = primary;
...
export const cardInnerBorderRadius = `calc(${stripUnit(cardBorderRadius)}px - ${stripUnit(cardBorderWidth)})}px)`;
